...
import kotlinx.android.synthetic.main.autocomplete_1.*

class AutoComplete1 : Activity() {
    ...
    companion object {
        ...
        val COUNTRIES = arrayOf("Afghanistan", "Albania", "Algeria",
                ...
                "Northern Marianas", "Norway", "Oman", "Pakistan", "Palau", "Panama",
