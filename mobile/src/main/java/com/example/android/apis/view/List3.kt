...
class List3 : ListActivity() {
    ...
    private val mAdapter: SimpleCursorAdapter by lazy {
        ...
        SimpleCursorAdapter(this,
                ...
                arrayOf(Phone.TYPE, Phone.NUMBER),
    ...
    companion object {
        private val PHONE_PROJECTION = arrayOf(Phone._ID, Phone.TYPE, Phone.LABEL, Phone.NUMBER)

        private val COLUMN_TYPE = 1
        private val COLUMN_LABEL = 2
    }
}