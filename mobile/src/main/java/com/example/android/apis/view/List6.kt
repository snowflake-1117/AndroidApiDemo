...
class List6 : ListActivity() {
    ...
    private inner class SpeechListAdapter(
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
            return when (convertView) {
                null -> SpeechView(mContext, mTitles[position], mDialogue[position], mExpanded[position])
                else ->
                    (convertView as SpeechView).apply {
                        setTitle(mTitles[position])
                        setDialogue(mDialogue[position])
                        setExpanded(mExpanded[position])
                    }
            }
        }
         ...
         * Our data, part 1.
         */
        private val mTitles = arrayOf("Henry IV (1)", "Henry V", "Henry VIII", "Richard II", "Richard III", "Merchant of Venice", "Othello", "King Lear")

        /**
         * Our data, part 2.
         */
        private val mDialogue = arrayOf("So shaken as we are, so wan with care," +
         ...
         * Our data, part 3.
         */
        private val mExpanded = booleanArrayOf(false, false, false, false, false, false, false, false)
    }
     ...
     *
     */
    private inner class SpeechView(context: Context, title: String, dialogue: String, expanded: Boolean) : LinearLayout(context) {
        ...
        init {
            ...
            mTitle = TextView(context).apply {
                text = title
                addView(this, LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT))
            }

            mDialogue = TextView(context).apply {
                text = dialogue
                addView(this, LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT))
